...
using zStart.Authorization;
using zStart.Helpers;
using System;
...
namespace zStart
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("zStart")));
            options.UseNpgsql(Configuration["ConnectionStrings:postgreSqlConnection"], b => b.MigrationsAssembly("zStart")));
            // add identity
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - zStart";
