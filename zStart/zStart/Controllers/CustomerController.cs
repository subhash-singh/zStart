...
using DAL;
using zStart.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using zStart.Helpers;

namespace zStart.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from zStart", message);
